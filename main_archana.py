...
parser.add_argument('-bert_num', '--bert_num', help='Bert Model number',
...
def run(opt, keeper):
    ...
    for fold_index in range(5):
        ...
        eval_path = './eval_results/oct2/'
        if not os.path.exists(eval_path):
                os.mkdir(eval_path)
        out_f = '{}{}_{}_{}_{}_{}_bert{}.txt'.format(eval_path, m[2], m[3][:2], p[1], p[2], fold_index, opt.bert_num)
...
if __name__ == '__main__':
    ...
    ignore_keys = {'overwrite', 'save', 'skip', 'debug', 'grid_search',}
